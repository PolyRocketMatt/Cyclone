...
public class ArithmeticMulTask extends ParallelTensorTask {

    private float value;
    private final int size;
    private final String id;

    public ArithmeticMulTask(@NotNull TornadoNativeArray buffer, float value, int size) {
        super(buffer);
        this.value = value;
        this.size = size;
        this.id = "mul_%s".formatted(TaskUtils.randomIdentifier(8));
    }
