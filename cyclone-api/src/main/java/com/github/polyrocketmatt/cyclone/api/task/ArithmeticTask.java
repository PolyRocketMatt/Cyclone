...
public interface ArithmeticTask extends BufferTask {
     ...
     *
     * @param input The buffer to execute the arithmetic task on.
     ...
     * @return The output buffer with the result of the arithmetic task.
     */
    @NotNull CycloneBuffer<Float> execute(@NotNull CycloneBuffer<Float> input, @NotNull FloatArray output, @NotNull FloatArray values, int size);
